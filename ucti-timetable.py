...
def makefile(base_url,intake,week,storage_file,file_name):
...
def main(argv=None):
    ...
    if not os.path.exists(storage_dir):
        ...
        makefile(base_url,intake,week,storage_file,file_name)
        usefirefox(storage_file)
